...
#endif
#include <iostream>
class InstructionMemory_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    InstructionMemory_api_t(VInstructionMemory* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["InstructionMemory.reset"] = 0;
    }
#if VM_TRACE
...
static InstructionMemory_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/examples/InstructionMemory/InstructionMemory.vcd";
...
#endif
    InstructionMemory_api_t api(top);
