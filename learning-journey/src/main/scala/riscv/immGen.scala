...
class immGen extends Module{
  ...
  io.sb := Cat(Fill(19,imm31),imm31,imm7,imm30,imm11,0.U).asSInt + io.pc
  io.u := Cat(Fill(12,0.U),imm31,imm30,imm24,imm20,imm19).asSInt << 12.U
  io.uj := Cat(Fill(11,imm31),imm31,imm19,imm20,imm30,imm24,0.U).asSInt + io.pc
}
