    ...
    if ex[0] =="jalr":
        ...
        if len(regs) == 1:
            ...
            if regs[0] == "ra" and regs[1] != "zero" and regs[2] == "0":
                ...
                Machine[rep] = f
                PC[index] = 2
print("Distance from Instruction to Label",calculateUpwardLabel("10154:","sw zero,-36(s0)"))
#print(PC.count(2))
count = 0
for i in Assembly:
    if i[0:2] == "c.":
...
myfile = open('c_extension_dump.txt','r')

data = myfile.readlines()
myfile.close()
f = open("c_converted_machine.txt","w")
del data[0]
for i in data:
    a = i.split()
    #print(a[1])
